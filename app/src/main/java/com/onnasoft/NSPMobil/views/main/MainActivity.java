...
import com.onnasoft.NSPMobil.Const.Broadcast;
import com.onnasoft.NSPMobil.Const.JsonTag;
...
//        IntentFilter filter2 = new IntentFilter(BTDuplicateRemoveBroadcasterReceiver.ACTION_BT_CONNECTED);
//        registerReceiver( mBTDuplicateRemoveBroadcasterReceiver ,  filter2);
	...
	private void handleMsg( int penMsgType, String content )
	{
		...
		switch ( penMsgType )
		{
			...
			case PenMsgType.PEN_CONNECTION_FAILURE_BTDUPLICATE:
				...
				Util.showToast( this, connected_Appname+" 에 BT가 연결되어 있는 상태입니다. "+connected_Appname+" 에서 BT 해제후 연결시도하세요" );
				break;
